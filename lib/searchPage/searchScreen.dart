...
//                       itemCount: isSearch
//                           ? lstSearchUserPhone.length
//                           : searchedUserDetail.length,
//                       itemBuilder: (BuildContext context, index) {
//                         var data =
//                             isSearch ? lstSearchUserPhone : searchedUserDetail;
//                         return Column(
//                           crossAxisAlignment: CrossAxisAlignment.start,
//                           children: [
//                             InkWell(
//                                 //makes whole card tappable (should refactor as function later)
//                                 onTap: () async {
//                                   var obj = await ApiProvider()
//                                       .getProfileDetail(data[index].userId);
...
//       lstSearchedUserDetail =
//           (await ApiProvider().searchUser("searchPhone", text))
//               .cast<UserPhone>();
//     } else {
//       lstSearchedUserDetail =
//           (await ApiProvider().searchUser("searchUserName", text))
//               .cast<UserPhone>();
//     }
