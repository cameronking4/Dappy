              ...
              Expanded(
                ...
                child: Container(
                  ...
                  child: Text(
                    ...
                    textAlign: TextAlign.center,
                    style: TextStyle(color: Colors.black, fontSize: 14.0, fontFamily: 'Gotham-Medium', fontWeight: FontWeight.bold),
                  ),
                ),
              ),
              Expanded(
                ...
                child: Container(
                  ...
                  child: Text(
                    ...
                    textAlign: TextAlign.center,
                    style: TextStyle(color: Colors.black, fontSize: 16.0, fontFamily: 'Gotham-Medium', fontWeight: FontWeight.bold),
                  ),
                ),
              ),
              Expanded(
    ...
    if (user != null) {
      await Firestore.instance.collection('Users').document(user.uid).get().then((snapshot) async {
        if (snapshot == null) {
          ...
          if (snapshot == null || ProfileModel.parseSnapshot(snapshot).firstName == '') {
